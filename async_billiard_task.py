...
def check_misspelled(response):
    ...
    response["misspelled"] = miss_spelled
    response["correct_keyword"] = smallest_suggestion
    return response
...
for result in results:
    check_misspelled(result)

# for m in range(len(results)):
#     keyword = results[m]["keyword"]
#     suggestions = results[m]["suggestions"]
#     misspelled, correct_keyword = check_misspelled(keyword, suggestions)
#     results[m]["misspelled"] = misspelled
#     results[m]["correct_keyword"] = correct_keyword
